...
export default function NavBar() {
  ...
  return (
    ...
    // <nav class="fixed top-0 z-10 fixed w-full max-w-full bg-white border rounded-none h-max border-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
      <header className="bg-white fixed top-0 z-10 fixed w-full max-w-full bg-white border rounded-none h-max border-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 ">
